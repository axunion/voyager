...
| # | spec | 規模 | ステータス | 備考 |
| --- | --- | --- | --- | --- |
| 01 | [Open behavior](01-open-behavior.md) — ダブルクリック / Enter で開く | 小 | 未着手 | |
| 02 | [Tabs](02-tabs.md) — マルチタブ化 | 大 | 未着手 | マイルストーン A/B で 2 セッション可 |
| 03 | [Keyboard navigation](03-keyboard-navigation.md) — 矢印・Enter・Delete | 小 | 未着手 | |
| 04 | [Tree view](04-tree-view.md) — サイドバーのフォルダツリー | 中 | 未着手 | |
